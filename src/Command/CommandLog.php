...
class CommandLog
{
	...
	private function write($type, $output, $debug = true)
	{
	...
	public function out($output, $debug = true)
	{
		return $this->write('out', $output, $debug);
	}

	public function info($output, $debug = true)
	{
		return $this->write('info', $output, $debug);
	}

	public function warning($output, $debug = true)
	{
		return $this->write('warning', $output, $debug);
	}

	public function error($output, $debug = true)
	{
		return $this->write('error', $output, $debug);
	}

	public function success($output, $debug = true)
	{
